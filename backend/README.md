...
## Project Structure
    ...
    ├── uttaraditguide_29004  # Django project configurations
...
1. Clone this repo and `cd uttaraditguide_29004`
...
2. Clone this repo and `cd uttaraditguide_29004`
